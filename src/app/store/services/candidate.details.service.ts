...
export class CandidateDetailsService extends EntityCollectionServiceBase<CandidateDetailsHeader> {
  ...
  getRaisedByIndustry(candidateId: string): Observable<CandidateDetailsRaisedByGroup>  {
    const URL = `${this.host}/api/candidate/raised-by-industry/${candidateId}`;
  ...
  getRaisedByLocation(candidateId: string): Observable<CandidateDetailsRaisedByLocation>  {
    const URL = `${this.host}/api/candidate/raised-by-location/${candidateId}`;
  ...
  getOutsideMoney(candidateId: string): Observable<CandidateDetailsOutsideMoney>  {
    const URL = `${this.host}/api/candidate/raised-outside-money/${candidateId}`;
